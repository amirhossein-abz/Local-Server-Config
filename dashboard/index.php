...
<header>
    <nav>
        <ul>
            ...
            <li id="phpmyadmin"><a target="_blank" href="Storage/"><span
                            id="php">Storage</span></a></li>
        </ul>
    </nav>
</header>
        ...
        foreach (scandir($dir) as $value) {
            if ($value != ".git" && $value != "icon.ico" && $value != "icon.ico" && $value != ".idea" && $value != "index.css" && $value != "index.php" && $value != "Deleted" && $value != "." && $value != "..") {
                echo "
                    <div class='dir-item'>
                        <div class='inner-values'>
                            <a target='_blank' href='$value' class='values'>$value</a>
                            ";
                foreach (scandir("./$value/") as $inner) {
                    if ($inner != "." && $inner != ".." && !str_starts_with($inner,".")) {
                ...
                echo "
                        ...
                        <a target='_blank' href='$value' class='enter'>Enter</a>
                    </div> 
                ";
            }
        } ?>
